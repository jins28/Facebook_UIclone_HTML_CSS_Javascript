(function(g){var window=this;'use strict';var Fmb=function(a,b){g.W.call(this,{I:"button",Na:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},X:[{I:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},X:[{I:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},X:[{I:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
X:[{I:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.LQ(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.qb(this,g.EQ(b.Ec(),this.element))},Gmb=function(a){g.W.call(this,{I:"div",
T:"ytp-miniplayer-ui"});this.xg=!1;this.player=a;this.V(a,"minimized",this.Fh);this.V(a,"onStateChange",this.XQ)},Hmb=function(a){g.CR.call(this,a);
this.B=new g.KL(this);this.j=new Gmb(this.player);this.j.hide();g.jQ(this.player,this.j.element,4);a.yg()&&(this.load(),g.mr(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(Fmb,g.W);Fmb.prototype.onClick=function(){this.J.Ua("onExpandMiniplayer")};g.x(Gmb,g.W);g.k=Gmb.prototype;
...
g.k.uy=function(){};
g.k.Ps=function(){};
g.k.NE=function(){};g.x(Hmb,g.CR);g.k=Hmb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.mr(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.BR("miniplayer",Hmb);})(_yt_player);
